...
int main(int argc, char *argv[])
{
    ...
    {
        BPlusTree tree("test.db", true);
        assert(tree.meta_.order == 4);
        assert(tree.meta_.value_size == sizeof(bpt::value_t));
        assert(tree.meta_.key_size == sizeof(bpt::key_t));
        assert(tree.meta_.internal_node_num == 1);
        assert(tree.meta_.leaf_node_num == 1);
        assert(tree.meta_.height == 1);
        PRINT("EmptyTree");
        tree.Print();
    }

    {
        ...
        assert(tree.Insert("t2", 2).OK());
        assert(tree.Insert("t4", 4).OK());
        assert(tree.Insert("t1", 1).OK());
        assert(tree.Insert("t3", 3).OK());
        tree.Print();
    }

    {
        ...
        assert(tree.Insert("t1", 4).Exist());
        assert(tree.Insert("t2", 4).Exist());
        assert(tree.Insert("t3", 4).Exist());
        assert(tree.Insert("t4", 4).Exist());
        PRINT("Insert4Elements");

        for (size_t i = 5; i < 100; i++) {
            std::string s = "t" + std::to_string(i);
            assert(tree.Insert(s.c_str(), i).OK());
            tree.Print(); 
        }
    ...
    // assert(tree.meta_.key_size == sizeof(bpt::key_t));
    // assert(tree.meta_.internal_node_num == 1);
    // assert(tree.meta_.leaf_node_num == 2);
    // assert(tree.meta_.height == 1);
    ...
    // assert(tree.meta_.order == 4);
    // assert(tree.meta_.internal_node_num == 1);
    // assert(tree.meta_.leaf_node_num == 3);
    // assert(tree.meta_.height == 1);
    ...
    // BPlusTree tree("test.db");
    // assert(tree.meta_.order == 4);
    // assert(tree.meta_.internal_node_num == 3);
    // assert(tree.meta_.leaf_node_num == 5);
    // assert(tree.meta_.height == 2);

    // bpt::internal_node_t node1, node2, root;
    // tree.map(&root, tree.meta_.root_offset);
    ...
    // assert(tree.meta_.order == 4);
    // assert(tree.meta_.internal_node_num == 1);
    // assert(tree.meta_.leaf_node_num == 4);
    // assert(tree.meta_.height == 1);

    // bpt::internal_node_t node;
    // tree.map(&node, tree.meta_.root_offset);
    // assert(node.n == 4);
    ...
    // {
    // BPlusTree tree("test.db");
    // assert(tree.meta_.internal_node_num == 5);
    // assert(tree.meta_.leaf_node_num == 10);
    // assert(tree.meta_.height == 2);
    ...
    // {
    // BPlusTree tree("test.db");
    // assert(tree.meta_.internal_node_num == 9);
    // assert(tree.meta_.leaf_node_num == 17);
    // assert(tree.meta_.height == 3);
    ...
    // off_t offset = tree.meta_.leaf_offset;
    // off_t last = 0;
    // size_t counter = 0;
    // while (offset != 0) {
    ...
    //     offset = leaf.next;
    // }
    // assert(counter == tree.meta_.leaf_node_num);
    ...
    // bpt::leaf_node_t leaf;
    // tree.map(&leaf, tree.meta_.leaf_offset);
    // assert(leaf.n == 3);
    ...
    // assert(leaf.parent == tree.meta_.root_offset);
    // assert(leaf.n == 2);
    ...
    // assert(tree.meta_.internal_node_num == 5);
    // assert(tree.meta_.leaf_node_num == 8);
    // assert(tree.meta_.height == 2);
